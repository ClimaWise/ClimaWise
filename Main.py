...
task_list = {
    ...
    "Keywords Extraction - Excerpt": "You're an expert policymaker specialized in climate change. Extract the most relevant keywords from the following text:\n\n{input}",
    "Keywords Extraction - Full Policy": "keyword_chunking_task",
